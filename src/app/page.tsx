...
// 	return (
// 		<div className='min-h-screen bg-gradient-to-br from-blue-50 to-white overflow-hidden text-slate-800'>
// 			{/* Navigation */}
...
// 				</div>
// 				<Link href='/sign-in'>
// 					<button className='px-6 py-2 rounded-full bg-white text-blue-600 font-semibold shadow-sm hover:shadow-md transition-all border border-blue-100'>
// 						Sign In
// 					</button>
// 				</Link>
// 			</nav>
...
// 						Welcome to <br />
// 						<span className='text-blue-600'>Mercy Schools Limited</span>
// 					</motion.h1>
...
// 					<motion.div variants={itemVariants}>
// 						<Link href='/sign-in'>
// 							<button className='group relative px-8 py-4 bg-blue-600 text-white text-lg font-bold rounded-full shadow-xl hover:bg-blue-700 transition-all flex items-center gap-3 mx-auto overflow-hidden'>
// 								<span className='relative z-10'>Access Portal</span>
// 								<ArrowRight className='w-5 h-5 relative z-10 group-hover:translate-x-1 transition-transform' />
...
// 						<div
// 							key={idx}
// 							className='bg-white p-8 rounded-2xl shadow-lg border border-blue-50 hover:-translate-y-1 transition-transform duration-300'>
...
// 			{/* Decorative Blobs */}
// 			<div className='absolute top-0 left-0 w-full h-full overflow-hidden -z-0 pointer-events-none'>
// 				<div className='absolute -top-[20%] -left-[10%] w-[50%] h-[50%] bg-blue-200/20 rounded-full blur-3xl animate-pulse' />
// 				<div className='absolute top-[20%] -right-[10%] w-[40%] h-[40%] bg-blue-300/20 rounded-full blur-3xl animate-pulse delay-75' />
// 			</div>
// 		</div>
// 	);
// }
